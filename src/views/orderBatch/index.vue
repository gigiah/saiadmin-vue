...
<script setup>
  ...
  import api from '@/api/orderBatch'
  ...
  const crud = reactive({
    ...
    add: { show: true, api: api.save, auth: ['/orderBatch/save'] },
    edit: { show: true, api: api.update, auth: ['/orderBatch/update'] },
    delete: { show: true, api: api.delete, auth: ['/orderBatch/destroy'] },
    recovery: { show: true, api: api.recovery, auth: ['/orderBatch/recovery']},
