...
<script setup>
  ...
  import api from '@/api/clientSalesType'
  ...
  const crud = reactive({
    ...
    add: { show: true, api: api.save, auth: ['/clientSalesType/save'] },
    edit: { show: true, api: api.update, auth: ['/clientSalesType/update'] },
    delete: { show: true, api: api.delete, auth: ['/clientSalesType/destroy'] },
    recovery: { show: true, api: api.recovery, auth: ['/clientSalesType/recovery']},
