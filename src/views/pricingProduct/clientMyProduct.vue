...
<script setup>
  ...
  const crud = reactive({
    ...
    add: { show: false, api: api.save, auth: ['/pricingProduct/save'] },
    edit: { show: false, api: api.update, auth: ['/pricingProduct/update'] },
    delete: { show: false, api: api.delete, auth: ['/pricingProduct/destroy'] },
    recovery: { show: false, api: api.recovery, auth: ['/pricingProduct/recovery']},
