...
<script setup>
  ...
  const crud = reactive({
    ...
    add: { show: true, api: api.save, auth: ['/orderFeedbackItem/save'] },
    edit: { show: true, api: api.update, auth: ['/orderFeedbackItem/update'] },
    delete: { show: true, api: api.delete, auth: ['/orderFeedbackItem/destroy'] },
