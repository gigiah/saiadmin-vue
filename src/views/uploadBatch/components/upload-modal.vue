...
<template>
	<a-modal :hide-title="true" :width="800" :visible="visible" title="上传文件" @ok="handleOk" @cancel="handleCancel">
		<a-form ref="uploadForm" :model="uploadData">
			...
			<a-form-item field="previewImages" label="预览图(最大2MB)">
				<oss-upload v-model="uploadData.previewImages" :limit="1" :max-size="2" />
			</a-form-item>
