...
<script setup>
  ...
  import api from '@/api/productGrade'
  ...
  const crud = reactive({
    ...
    add: { show: true, api: api.save, auth: ['/productGrade/save'] },
    edit: { show: true, api: api.update, auth: ['/productGrade/update'] },
    delete: { show: true, api: api.delete, auth: ['/productGrade/destroy'] },
    recovery: { show: true, api: api.recovery, auth: ['/productGrade/recovery']},
