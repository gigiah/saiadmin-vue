...
<script setup>
  ...
  import api from '@/api/clientLevelType'
  ...
  const crud = reactive({
    ...
    add: { show: true, api: api.save, auth: ['/clientLevelType/save'] },
    edit: { show: true, api: api.update, auth: ['/clientLevelType/update'] },
    delete: { show: true, api: api.delete, auth: ['/clientLevelType/destroy'] },
    recovery: { show: true, api: api.recovery, auth: ['/clientLevelType/recovery']},
