...
<script setup>
  ...
  import api from '@/api/storePricingType'
  ...
  const crud = reactive({
    ...
    add: { show: true, api: api.save, auth: ['/storePricingType/save'] },
    edit: { show: true, api: api.update, auth: ['/storePricingType/update'] },
    delete: { show: true, api: api.delete, auth: ['/storePricingType/destroy'] },
    recovery: { show: true, api: api.recovery, auth: ['/storePricingType/recovery']},
