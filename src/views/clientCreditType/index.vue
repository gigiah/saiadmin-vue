...
<script setup>
  ...
  import api from '@/api/clientCreditType'
  ...
  const crud = reactive({
    ...
    add: { show: true, api: api.save, auth: ['/clientCreditType/save'] },
    edit: { show: true, api: api.update, auth: ['/clientCreditType/update'] },
    delete: { show: true, api: api.delete, auth: ['/clientCreditType/destroy'] },
    recovery: { show: true, api: api.recovery, auth: ['/clientCreditType/recovery']},
