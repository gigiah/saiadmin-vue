...
<script setup>
  ...
  import api from '@/api/storeProductType'
  ...
  const crud = reactive({
    ...
    add: { show: true, api: api.save, auth: ['/storeProductType/save'] },
    edit: { show: true, api: api.update, auth: ['/storeProductType/update'] },
    delete: { show: true, api: api.delete, auth: ['/storeProductType/destroy'] },
    recovery: { show: true, api: api.recovery, auth: ['/storeProductType/recovery']},
