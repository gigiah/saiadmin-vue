...
const crud = reactive({
  ...
  add: { show: sysInfoStore.info?.is_admin ? true : false, api: api.save, auth: ['/pricingNonStandrd/save'] },
  edit: { show: sysInfoStore.info?.is_admin ? true : false, api: api.update, auth: ['/pricingNonStandrd/update'] },
  delete: { show: sysInfoStore.info?.is_admin ? true : false, api: api.delete, auth: ['/pricingNonStandrd/destroy'] },
  recovery: { show: sysInfoStore.info?.is_admin ? true : false, api: api.recovery, auth: ['/pricingNonStandrd/recovery'] },
