...
<script setup>
  ...
  import api from '@/api/storeAreaType'
  ...
  const crud = reactive({
    ...
    add: { show: true, api: api.save, auth: ['/storeAreaType/save'] },
    edit: { show: true, api: api.update, auth: ['/storeAreaType/update'] },
    delete: { show: true, api: api.delete, auth: ['/storeAreaType/destroy'] },
    recovery: { show: true, api: api.recovery, auth: ['/storeAreaType/recovery']},
