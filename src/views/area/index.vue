...
const crud = reactive({
  ...
  add: { show: true, api: api.save, auth: ['/area/save'] },
  edit: { show: false, api: api.update, auth: ['/area/update'] },
  delete: { show: true, api: api.delete, auth: ['/area/destroy'] },
  recovery: { show: true, api: api.recovery, auth: ['/area/recovery'] },
