...
<script setup>
  ...
  import api from '@/api/summaryBatch'
  ...
  const crud = reactive({
    ...
    add: { show: true, api: api.save, auth: ['/summaryBatch/save'] },
    edit: { show: true, api: api.update, auth: ['/summaryBatch/update'] },
    delete: { show: true, api: api.delete, auth: ['/summaryBatch/destroy'] },
    recovery: { show: true, api: api.recovery, auth: ['/summaryBatch/recovery']},
